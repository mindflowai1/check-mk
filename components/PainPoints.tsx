      ...
      <div className="container mx-auto px-6">
        ...
        <div className="flex flex-col items-center text-center mb-24 max-w-4xl mx-auto">
          <motion.div
            ...
            viewport={{ once: true }}
          >
            <span className="text-brand font-bold text-xs tracking-[0.2em] uppercase mb-6 block">
              {t.pain.tag}
            </span>
            <h2 className="font-display text-4xl md:text-5xl lg:text-7xl font-bold text-white leading-tight tracking-tight mb-8">
              {t.pain.title} <br className="hidden md:block" />
            ...
            <motion.a
              ...
              whileTap={{ scale: 0.95 }}
              className="inline-flex items-center justify-center px-8 py-4 bg-brand text-dark-900 font-bold text-sm uppercase tracking-wider rounded-lg shadow-[0_0_20px_rgba(98,174,136,0.4)] hover:shadow-[0_0_30px_rgba(98,174,136,0.6)] transition-all duration-300"
            >
              {t.pain.cta}
            </motion.a>
          </motion.div>
